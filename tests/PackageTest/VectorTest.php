...
class VectorTest extends TestCase
{
    ...
    public function test_vector_insert(): void
    {
        ...
        $response = $this->milvus->vector()->insert($collectionName, $data);
        ...
        // Flush data to disk
        $this->milvus->collection()->flushCollection($collectionName);
        
        // Load collection to memory for queries
        $this->milvus->collection()->loadCollection($collectionName);
    ...
    public function test_vector_get(): void
    {
        ...
        $this->milvus->vector()->insert($collectionName, $data);
        ...
        $response = $this->milvus->vector()->get($collectionName, [1, 3, 5], ['color']);
        var_dump($response->body());
    ...
    public function test_vector_delete(): void
    {
        ...
        $response = $this->milvus->vector()->delete($collectionName, 'id == 1');
        var_dump($response->body());
    ...
    public function test_vector_hybrid_search(): void
    {
        ...
        $response = $this->milvus->vector()->hybridSearch(
            $collectionName,
            $search,
            $rerank,
            3,
    ...
    public function test_vector_query(): void
    {
        ...
        $response2 = $this->milvus->vector()->query(
            $collectionName,
        ...
        $response3 = $this->milvus->vector()->query(
            $collectionName,
            "id in [1, 4, 10]",
            null,
            ['id', 'color'],
    ...
    public function test_vector_search(): void
    {
        ...
        $response = $this->milvus->vector()->search(
            $collectionName,
            $searchData,
            'vector',
            null,
        ...
        $response2 = $this->milvus->vector()->search(
            $collectionName,
            $searchData,
            'vector',
            null,
    ...
    public function test_vector_upsert(): void
    {
        ...
        $response = $this->milvus->vector()->upsert($collectionName, $data);
        var_dump($response->body());
        ...
        $response2 = $this->milvus->vector()->upsert($collectionName, $updateData);
        var_dump($response2->body());
